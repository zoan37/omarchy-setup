...
systemctl daemon-reload; systemctl enable a16-quiet-thermal.service a16-fan-daemon.service a16-nvme-aspm.service a16-whine-tweaks.service >/dev/null 2>&1 || true
